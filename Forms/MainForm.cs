...
namespace Flintstones
{
  public class MainForm : Form
  {
    ...
    private void launchDarkAgesToolStripMenuItem_Click(object sender, EventArgs e)
    {
      if (!File.Exists(Options.FullDarkAgesPath))
      {
        ...
        private void Launch()
        {
            ...
            string dllDestination = Path.Combine(Path.GetDirectoryName(exePath), dllName);
            ...
            if (this.InjectDawnd.Checked)
            {
                dllPath = dllDestination;
                IntPtr hProcess = processInfo.ProcessHandle;

                IntPtr remoteString = Kernel32.VirtualAllocEx(
                    hProcess,
                    IntPtr.Zero,
                    (uint)(dllDestination.Length + 1),
                    AllocationType.Commit,
                    MemoryProtection.ReadWrite
                );

                IntPtr destinationAddress = Marshal.StringToHGlobalAnsi(dllDestination);
                Kernel32.WriteProcessMemory(hProcess, remoteString, destinationAddress, dllDestination.Length + 1, out _);
                Marshal.FreeHGlobal(destinationAddress);

                IntPtr loadLibraryAddr = Kernel32.GetProcAddress(Kernel32.GetModuleHandle("kernel32.dll"), "LoadLibraryA");
                IntPtr remoteThread = Kernel32.CreateRemoteThread(hProcess, IntPtr.Zero, 0, loadLibraryAddr, remoteString, 0, IntPtr.Zero);
    ...
    private void InitializeComponent()
    {
            ...
            this.InjectDawnd = new System.Windows.Forms.CheckBox();
            ...
            this.addfriend_name.Size = new System.Drawing.Size(135, 23);
            ...
            this.deletefriend.Size = new System.Drawing.Size(135, 31);
            ...
            this.label7.Size = new System.Drawing.Size(177, 45);
            ...
            this.addfriend_button.Size = new System.Drawing.Size(107, 33);
    ...
    "\nLogged off skulled:";
            ...
            this.Controls.Add(this.InjectDawnd);
