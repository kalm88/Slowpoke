...
namespace Flintstones
{
    public class MainForm : Form
    {
        ...
        public void OnExit(bool d = false)
        {
            ...
            //
            // Mort: Commented out because of weird system delete commands that cannot work anyway due to parameter format issues.
            //
    ...
    "\nLogged off skulled:";
        ...
        private void pregroup_CheckedChanged(object sender, EventArgs e)
        {
            if (pregroup.Checked)
            {
                Options.HasForceGroup = true;
            }
            else
            {
                Options.HasForceGroup = false;
            }

            Options.Save();
        }

        private void pregroupname_TextChanged(object sender, EventArgs e)
        {
            if (pregroupname.Text.Length > 0)
            {
                Options.ForceGroupName = pregroupname.Text;
            }
            else
            {
                Options.ForceGroupName = "";
            }

            Options.Save();
        }

        private void preplay_CheckedChanged(object sender, EventArgs e)
        {
            if (preplay.Checked)
            {
                Options.PreplayEnabled = true;
            }
            else
            {
                Options.PreplayEnabled = false;
            }
